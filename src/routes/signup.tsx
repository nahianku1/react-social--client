...
function RouteComponent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-custom-back px-4 sm:px-6 lg:px-8">
      ...
      <CardHeader>
        <CardTitle className="text-center text-black text-2xl sm:text-3xl font-semibold">
        Create Account
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-5">
        ...
        <Link to="/signin" className="underline hover:text-gray-700">
          Signin
        </Link>
        </div>
      </CardContent>
